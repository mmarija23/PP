...
function tellFortune(numOfChildren, partnersName, geoLocation, jobTitle) {
    var future = 'You will be a ' + jobTitle + ' in ' + geoLocation + ' and married to ' +
        partnersName + ' ' + ' with ' + numOfChildren + ' kids.';

    console.log(future);
}
tellFortune(2, 'Leo', 'Jamaica', 'pilot');
tellFortune(1, 'Anna', 'Greece', 'writer');
tellFortune(4, 'Mark', 'Russia', 'player');
...
function calculateSupply(age, amountPerDay) {
    ...
    var out = 'You will need ' + amount + ' to last you untill the ripe old age of ';
    console.log(out);
}
...
● Convert it to celsius and output "NN°F is NN°C."kraj*/
